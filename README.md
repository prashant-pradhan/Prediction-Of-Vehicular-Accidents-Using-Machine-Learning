...
MTECH (CSE) Final Year Project on Prediction Of Vehicular Accidents Using Machine Learning using user's Location,weather conditions by applying machine Learning concepts.
...
I chosen Random Forest as our model as it has the highest accuracy (86.86%).
